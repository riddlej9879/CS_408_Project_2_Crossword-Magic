...
public class PuzzleDAO {
    ...
    public Puzzle find(SQLiteDatabase db, int id) {
        ...
        if (cursor.moveToFirst()) {
            ...
            params.put(daoFactory.getProperty("sql_field_puzzleid"),    String.valueOf(cursor.getString(0)));
            params.put(daoFactory.getProperty("sql_field_name"),        String.valueOf(cursor.getString(1)));
            params.put(daoFactory.getProperty("sql_field_description"), String.valueOf(cursor.getString(2)));
            params.put(daoFactory.getProperty("sql_field_height"),      String.valueOf(cursor.getString(3)));
            params.put(daoFactory.getProperty("sql_field_width"),       String.valueOf(cursor.getString(4)));
            ...
            if (cursor.moveToFirst()) {
                ...
                do {
                    ...
                    /* INSERT YOUR CODE HERE */
                    params.put(daoFactory.getProperty("sql_field_id"),          String.valueOf(cursor.getString(0)));
                    params.put(daoFactory.getProperty("sql_field_puzzleid"),    String.valueOf(cursor.getString(1)));
                    params.put(daoFactory.getProperty("sql_field_row"),         String.valueOf(cursor.getString(2)));
                    params.put(daoFactory.getProperty("sql_field_column"),      String.valueOf(cursor.getString(3)));
                    params.put(daoFactory.getProperty("sql_field_box"),         String.valueOf(cursor.getString(4)));
                    params.put(daoFactory.getProperty("sql_field_direction"),   String.valueOf(cursor.getString(5)));
